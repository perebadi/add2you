  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved test as @test" do
        ...
        post :create, {:test => { "title" => "invalid value" }}, valid_session
        assigns(:test).should be_a_new(Test)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested test" do
        ...
        Test.any_instance.should_receive(:update).with({ "title" => "MyString" })
        put :update, {:id => test.to_param, :test => { "title" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the test as @test" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Test.any_instance.stub(:save).and_return(false)
        put :update, {:id => test.to_param, :test => { "title" => "invalid value" }}, valid_session
        assigns(:test).should eq(test)
      end
